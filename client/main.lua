...
RegisterKeyMapping('radialmenu', 'Open Radial Menu', 'keyboard', 'Q')
...
RegisterNetEvent('esx-radialmenu:client:noPlayers')
AddEventHandler('esx-radialmenu:client:noPlayers', function(data)
...
RegisterNetEvent('esx-radialmenu:client:giveidkaart')
AddEventHandler('esx-radialmenu:client:giveidkaart', function(data)
    -- ??
end)

RegisterNetEvent('esx-radialmenu:client:openDoor')
AddEventHandler('esx-radialmenu:client:openDoor', function(data)
...
RegisterNetEvent('esx-radialmenu:client:setExtra')
AddEventHandler('esx-radialmenu:client:setExtra', function(data)
    local string = data.id
...
RegisterNetEvent('esx-radialmenu:trunk:client:Door')
AddEventHandler('esx-radialmenu:trunk:client:Door', function(plate, door, open)
...
RegisterNetEvent('esx-radialmenu:client:ChangeSeat')
AddEventHandler('esx-radialmenu:client:ChangeSeat', function(data)
    local Veh = GetVehiclePedIsIn(PlayerPedId())

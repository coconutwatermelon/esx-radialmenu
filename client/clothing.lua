...
RegisterNetEvent('esx-radialmenu:ResetClothing')
AddEventHandler('esx-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('esx-radialmenu:ToggleClothing')
AddEventHandler('esx-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('esx-radialmenu:ToggleProps')
AddEventHandler('esx-radialmenu:ToggleProps', ToggleProps)
